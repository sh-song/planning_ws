...
(cl:defmethod cl:initialize-instance :after ((m <Serial_Info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Serial_Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name new_gigacha-msg:<Serial_Info> is deprecated: use new_gigacha-msg:Serial_Info instead.")))
